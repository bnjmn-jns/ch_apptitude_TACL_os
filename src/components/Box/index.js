...
const Box = styled(({ borderTop, padding, smPadding, mdPadding, lgPadding, children }) => <Grid>{children}</Grid>)`
  box-sizing: border-box;
  width: 100%;
  display: inline-block;
  background-color: white;
  ${props => props.borderTop && 'border-top: solid 1px #efecea;'} ${Media.xs`
